<%@ Page Title="XÓA NỘI DUNG" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="DelContact.aspx.cs" Inherits="System_DelContact" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">XÓA NỘI DUNG LIÊN HỆ</h3>
        </div>
        <br />
        <br />
