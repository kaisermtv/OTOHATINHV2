<%@ Page Title="NHÓM TÀI KHOẢN" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="GroupAccountEdit.aspx.cs" Inherits="Admin_GroupAccountEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
                    ...
                    <table class="DataListTable" border="0">
                        <tr>
                            ...
                            <td class="DataListTableTdItemCenter" style="width: 8%;">
                                <a href="PermissionAdd?Fid=<%# Eval("FunctionId") %>&Gid=<%# Eval("GroupId") %>"><B>Cập nhật</B></a>
                            </td>
                            <td class="DataListTableTdItemCenter" style="width: 8%;">
                                <a href="PermissionDel?Fid=<%# Eval("FunctionId") %>&Gid=<%# Eval("GroupId") %>"><B>Xóa quyền</B></a>
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
    ...
    <div class="AdminItem">
        ...
        <div class="AdminRightItem">
            ...
            &nbsp;
            <a href="PermissionAdd.aspx?Gid=<%Response.Write(this.itemId.ToString()); %>">
