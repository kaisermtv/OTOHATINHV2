<%@ Page Title="XÓA NỘI DUNG" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="PermissionDel.aspx.cs" Inherits="Admin_PermissionDel" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">XÓA QUYỀN TRUY CẬP</h3>
        </div>
        <br />
        <br />
